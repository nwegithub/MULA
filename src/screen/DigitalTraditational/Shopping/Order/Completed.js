...
import { GET_ORDER_BY_STATUS } from "../../../../graphql/queries";
import Loading from "../../../../component/Loading";

const Completed = ({ navigation }) => {
  const { user, langData } = useContext(Context);
  const { data, loading, refetch } = useQuery(GET_ORDER_BY_STATUS, {
    variables: { userId: user.id, status: "%complete%" }, fetchPolicy: "cache-and-network",
  });
